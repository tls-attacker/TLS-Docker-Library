...
public class PropertyManager {
    ...
    protected PropertyManager() {
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.CLIENT,
                        TlsImplementationType.BORINGSSL,
                        "master",
                        Const.CA_CERT,
                        false));
        imagePropertyList.add(
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.CLIENT,
                        TlsImplementationType.LIBRESSL,
                        "3.2.0",
                        Const.CA_CERT,
                        false));
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.CLIENT,
                        TlsImplementationType.MATRIXSSL,
                        "4.2.2",
                        Const.CA_CERT,
                        true));
        imagePropertyList.add(
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.CLIENT,
                        TlsImplementationType.TLSLITE_NG,
                        "0.8.0-alpha38",
                        Const.CA_CERT,
                        false));
        imagePropertyList.add(
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.SERVER,
                        TlsImplementationType.BOUNCYCASTLE,
                        "1.58",
                        4433,
                        "/cert/keys.jks",
                        "/cert/keys.jks",
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.SERVER,
                        TlsImplementationType.DAMNVULNERABLEOPENSSL,
                        "1.0",
                        4433,
                        Const.CERT_KEY_PEM,
                        Const.CERT_CERT_PEM,
        ...
        imagePropertyList.add(
                new ImageProperties(
                        ...
                        "3.2.0",
                        4433,
                        Const.RUST_TEST_CA_KEY,
                        Const.RUST_TEST_CA_FULLCHAIN,
                        null));
        imagePropertyList.add(
                new ImageProperties(
                        ConnectionRole.SERVER,
    ...
    public ImageProperties getProperties(ConnectionRole role, TlsImplementationType type) {
        ...
        throw new PropertyNotFoundException(
                "No " + role.name() + " properties found for: " + type.name());
    }
}
