...
public class ServerPropertyManager {
    ...
    public ServerPropertyManager() {
        ...
        propertyList.add(new ServerImageProperties(TlsImplementationType.S2N, 4430, "", Const.CERT_KEY_PEM, Const.CERT_CERT_PEM));
        propertyList.add(new ServerImageProperties(TlsImplementationType.LIBRESSL, 4433, "", Const.RUST_TEST_CA_KEY, Const.RUST_TEST_CA_FULLCHAIN));
