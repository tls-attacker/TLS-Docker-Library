...
if [ ! -z "$DOCKER_REPOSITORY" ]; then
	docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0
	docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0
fi
while (( i < max ))
do
	...
	if [ ! -z "$DOCKER_REPOSITORY" ]; then
		docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0${array[$i]}
		docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0${array[$i]}
	fi
	i=i+1
done
...
if [ ! -z "$DOCKER_REPOSITORY" ]; then
	docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0beta1
	docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0beta1
fi
...
if [ ! -z "$DOCKER_REPOSITORY" ]; then
	docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0beta2
	docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0beta2
fi
...
if [ ! -z "$DOCKER_REPOSITORY" ]; then
	docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0beta3
	docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0beta3
fi
...
if [ ! -z "$DOCKER_REPOSITORY" ]; then
	docker push ${DOCKER_REPOSITORY}openssl-server:1.0.0beta4
	docker push ${DOCKER_REPOSITORY}openssl-client:1.0.0beta4
fi
