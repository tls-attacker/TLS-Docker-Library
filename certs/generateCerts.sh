...
openssl req -new -config /run/cert.cfg -nodes -key rsa2048key.pem -out rsa2048cert.csr
openssl ca -config /run/cert.cfg -create_serial -batch -in rsa2048cert.csr -out rsa2048cert.pem
...
openssl req -new -config /run/cert.cfg -nodes -key ec256key.pem -out ec256cert.csr
openssl ca -config /run/cert.cfg -create_serial -batch -in ec256cert.csr -out ec256cert.pem
